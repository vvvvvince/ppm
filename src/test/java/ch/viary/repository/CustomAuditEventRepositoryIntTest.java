...
import ch.viary.config.audit.AuditEventConverter;
import ch.viary.domain.PersistentAuditEvent;
...
import static ch.viary.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
